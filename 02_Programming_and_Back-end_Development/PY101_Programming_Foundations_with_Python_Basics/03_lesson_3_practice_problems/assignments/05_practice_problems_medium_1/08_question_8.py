...
function named rps as follows, which follows the classic rules of the
...
# "scissors"), and combine them by calling rps on their results. Those innermost
# expressions return "paper" and "rock", respectively. Calling rps on those two
# values returns "paper", which, when evaluated against "rock", returns "paper".